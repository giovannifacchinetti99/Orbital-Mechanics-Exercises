...
from RepeatingGroundTrack import RepeatingGroundTrack
...
a_1 = RepeatingGroundTrack(12, 1, muP, wP)  # [km]
print(a_1)
e_1 = 0.19760  # [-]
...
a_2 = RepeatingGroundTrack(2, 1, muP, wP)  # [km]
print(a_2)
e_2 = 0.74  # [-]
...
# a_3 computed in the for cycle  # [km]
e_3 = 0  # [-]
...
for j in np.arange((len(i_3))):
    a_3 = RepeatingGroundTrack(k_vec[j], m_vec[j], muP, wP)
    print(a_3)
